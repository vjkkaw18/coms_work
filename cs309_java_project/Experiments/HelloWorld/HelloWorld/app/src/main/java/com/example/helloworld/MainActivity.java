...
/**
 * Main activity of the app, which is the registration page, and always directs to the login page after a successful registration or upon selecting the login page
 */
public class MainActivity extends AppCompatActivity {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!isEmpty(firstName) && !isEmpty(lastName) && !isEmail(email) == false) {
                    ...
                    usertypeu = usertype.getText().toString();
   ...
   //             practiceparse();
    ...
    /**
     * check if the EditText field is a valid email
     * @param text
     * @return
     */
    ...
    /**
     * check if a string meets email requirements
     * @param string
     * @return
     */
    ...
    /**
     * JsonArrayRequest to enable registration for the app for all users
     */
    ...
    /**
     * post new data to the logins database upon a successful registration
     */
