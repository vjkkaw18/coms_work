 ...
 */
public class ExampleDiagonalPieceTests
{
  /**
  ...
  public static void main(String[] args)
  {
    ...
    // then expected [Y(0, 1), C(1, 1), G(2, 1)]
    ...
    // expected [Y(10, 11), C(11, 11), G(12, 11)]
    ...
    // expected [Y(11, 13), C(12, 13), G(13, 13)]
    ...
    System.out.println(copy.getClass());  // should be IShape
    copy.shiftDown();
