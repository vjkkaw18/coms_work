...
//		if (p1.equals(p2))
		...
		if ((p1.getX() == p2.getX()) && (p1.getY() == p2.getY()))
		{
			return 0;
				...
				(comparePolarAngle(p1, p2) == 0) && compareDistance(p1, p2) < 0)
		{
			return -1;
		}
...
//    	if (compare(p1, p2) == 0)
    	if ((p1.getX() == p2.getX()) && (p1.getY() == p2.getY()))
    	{
    		return 0;
    			...
    			((crossProduct(p1, p1) == 0) && (dotProduct(p1, p1) > 0) && (crossProduct(p2, p2) == 0) && 
    					(dotProduct(p2, p2) > 0)))
    	{
    		return 0;
    	}
    ...
    {
    	int crossProd = ((p1.getX() - referencePoint.getX()) * (p2.getY() - referencePoint.getY())) - 
    ...
    {
    	int dotProd = ((p1.getX() - referencePoint.getX()) * (p2.getX() - referencePoint.getX())) + 
